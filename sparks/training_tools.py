...
from save_results_to_json import (get_binary_preds_pixel_based_results,
                                  get_class_pixel_based_results,
                                  get_binary_preds_spark_peaks_results,
                                  get_spark_peaks_results,
                                  get_average_results)
...
def test_function(network, device, criterion, ignore_frames, testing_datasets,
    ...
    pixel_based_results['sparks'] = {}
    pixel_based_results['puffs'] = {}
    pixel_based_results['waves'] = {}

    spark_peaks_results = {} # store metrics for each video
    spark_peaks_results['sparks'] = {}

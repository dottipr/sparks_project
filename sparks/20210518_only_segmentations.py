...
--> instead of using centers of sparks, use original segmentation !
...
(Cambiamenti rispetto all'altro script:
dataset_folders, criterion x loss fct, organizzazione degli args, training step
)
...
# DATASET OPTIONS
dataset_folder = "only_original_segmentation"

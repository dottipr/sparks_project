...
def add_colored_classes_to_video(movie, classes_mask, transparency=50,
    ...
    for event_class in classes:
        if classes_nb[event_class] in classes_mask:
            binary_preds = classes_mask == classes_nb[event_class]
            color_movie = add_colored_segmentation_to_video(segmentation=binary_preds,
                                                            video=color_movie,

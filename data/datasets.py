...
#         blocks_number = [
#             ((length - self.params.data_duration) // self.params.data_stride) + 1
...
#             video_length, self.params.data_stride, self.params.data_duration
#         )
...
#                     self.params.data_stride // self.params.num_channels,
